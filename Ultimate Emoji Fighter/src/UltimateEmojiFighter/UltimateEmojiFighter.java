...
public class UltimateEmojiFighter { //classe principal

    public static void main(String[] args) {
        Lutador l[] = new Lutador[6]; //array com 6 posições
        ...
        //nova luta
        Luta UEF01 = new Luta();
        UEF01.marcarLuta(l[teste], l[teste1]); //marcando luta
        UEF01.lutar();// lutar
    }
